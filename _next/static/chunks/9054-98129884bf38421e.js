"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[9054],{8028:function(r,o,i){i.d(o,{C:function(){return e},e:function(){return a}});const e=/[.*+?^${}()|[\]\\]/gu,a=/[0-9,.]/u},40265:function(r,o,i){i.d(o,{k:function(){return e}});const e={interpolate(r,o,i){if(2!==r.length||2!==o.length)throw new Error("inputRange and outputRange must be an array of length 2");const e=r[0]||0,a=r[1]||0,c=o[0]||0,s=o[1]||0;return i<e?c:i>a?s:(s-c)/(a-e)*(i-e)+c}}},77305:function(r,o,i){i.d(o,{$:function(){return s}});var e=i(49077),a=i(25156);function c(r,o,i){if(r===o)return!1;return(r-o<0?o-r:r-o)<=i+.1}const s={generate({uri:r,size:o,logoSize:i,dotColor:s="#141414"}){const l=[],t=function(r,o){const i=Array.prototype.slice.call(a.create(r,{errorCorrectionLevel:o}).modules.data,0),e=Math.sqrt(i.length);return i.reduce(((r,o,i)=>(i%e==0?r.push([o]):r[r.length-1].push(o))&&r),[])}(r,"Q"),n=o/t.length,u=[{x:0,y:0},{x:1,y:0},{x:0,y:1}];u.forEach((({x:r,y:o})=>{const i=(t.length-7)*n*r,a=(t.length-7)*n*o,c=.45;for(let r=0;r<u.length;r+=1){const o=n*(7-2*r);l.push(e.YP`
            <rect
